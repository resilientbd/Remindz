 ...
 */
package com.developersbd.alarm.alert;
...
import com.developersbd.alarm.SplashScreen;
...
//	private String answerString;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent myintent = new Intent(this.getApplicationContext(), SplashScreen.class);
		...
		Notification notificationpopup = new Notification.Builder(this)
				...
				.setAutoCancel(true)
				.setSmallIcon(R.drawable.alarmic)
				.build();
		try {
...
//			Float ans=mathProblem.getAnswer();
//			String ansStr=""+ans;
//			answerView.setText(ansStr);
			alarmActive = false;
			if (vibrator != null)
				vibrator.cancel();
			try {
