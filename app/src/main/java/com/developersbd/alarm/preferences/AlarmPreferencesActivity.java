...
import com.developersbd.alarm.BaseActivity;
import com.developersbd.alarm.R;
import com.developersbd.alarm.database.Database;
import com.developersbd.alarm.preferences.AlarmPreference.Key;
...
public class AlarmPreferencesActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		language= pref.getString("lan","en");
		//Toast.makeText(getBaseContext(),"Language in pf: "+language,Toast.LENGTH_LONG).show();
		...
		if (bundle != null && bundle.containsKey("adapter")) {
			...
			setListAdapter(new AlarmPreferenceListAdapter(this, getMathAlarm(),language));
		}
					...
					case STRING2:
						...
						alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int whichButton) {
								...
								if (alarmPreference.getKey() == Key.ALARM_NOTE) {

									alarm.setAlarmNote(alarmPreference.getValue().toString());
								}
...
//					timePickerDialog.setContentView(R.layout.timepickeractivity);
				...
				case DATE:
					DatePickerDialog datePickerDialog=new DatePickerDialog(AlarmPreferencesActivity.this, new DatePickerDialog.OnDateSetListener() {
						...
						public void onDateSet(DatePicker datePicker, int year, int month, int day) {
							newAlarmTime.set(Calendar.YEAR, year);
							newAlarmTime.set(Calendar.MONTH, month);
							newAlarmTime.set(Calendar.DAY_OF_MONTH, day);
							alarm.setAlarmTime(newAlarmTime);
							alarmPreferenceListAdapter.setMathAlarm(getMathAlarm());
							alarmPreferenceListAdapter.notifyDataSetChanged();

						}
					},alarm.getAlarmTime().get(Calendar.YEAR),alarm.getAlarmTime().get(Calendar.MONTH),alarm.getAlarmTime().get(Calendar.DAY_OF_MONTH));
